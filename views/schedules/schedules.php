...
<div class="accordion accordion-flush mx-3" id="accordionFlushExample">
    <h2 class="text-red p-0 m-0 text-end fs--1 title-h2-underline-white my-5">Nos horaires</h2>
            ...
            <div id="flush-collapse-<?= $key ?>" class="accordion-collapse collapse text-light" data-bs-parent="#accordionFlushExample">
                <div class="accordion-body">
                    <?php foreach($schedule->disciplines as $discipline): ?>
                        <h3 class="text-light col-12 text-center fw-bolder my-5">- <?= strtoupper($discipline->discipline_name) ?> -</h3>
                        <?php foreach($discipline->schedules as $key => $schedule): ?>
                            <div class="d-flex align-items-center justify-content-around flex-wrap align-content-center text-light w-100">
